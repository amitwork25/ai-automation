...
import { CcbpBillDeskBillsService } from "../../../../../src/services/eqx/bbps/ccbp/CcbpUtilitiesBillsV1Service";
import { buildBBPSHeadersRaw } from "../../../../../tests/integration/bbps/ccbp/shared/headers";


/** Generated smoke spec for ccbp.utilities_bills_v1. Extend with negative cases as needed. */
test("@smoke Verify ccbp.utilities_bills_v1 service method succeeds with auth headers", async ({ apiClient }) => {
