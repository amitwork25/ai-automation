...
import type { CcbpBillDeskUtilitiesBillsResponse } from "../../../../../models/eqx/bbps/ccbp/utilities-bills-v3-null.models";

const SCHEMA = "src/schemas/eqx/bbps/ccbp/utilities-bills-v3-null-response.schema.json";

/** Generated service for ccbp.utilities_bills_v3_null. */
export class CcbpBillDeskBillsService {
  constructor(private readonly api: ApiClient) {}

  private endpointPath(): string {
    return "/bbps/v3/billDesk/utilities/null/bills";
  }
  ...
  async utilitiesBillsByCustomerId(headers: Record<string, string>): Promise<CcbpBillDeskUtilitiesBillsResponse> {
    ...
    await SchemaValidator.validateFromFile(SCHEMA, result.json, "ccbp.utilities_bills_v3_null-response");
    await PerformanceValidator.responseTime(result.durationMs, 20_000, "ccbp.utilities_bills_v3_null");
    return result.json;
  }
}
