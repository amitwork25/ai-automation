...
describe("P4+ incremental, validate, traceability", () => {
  ...
  it("validates required artifacts for a completed run fixture set", async () => {
    ...
    const [serviceTestReport, assertionReport, journeyReport] = await Promise.all([
      readFixture<import("../../../src/contracts/pipeline.js").ServiceTestCodegenReportArtifact>(
        p3FixturesDir,
        "10-service-test-report.json"
      ),
      readFixture<import("../../../src/contracts/pipeline.js").AssertionCompileReportArtifact>(
        p3FixturesDir,
        "11-assertion-compile-report.json"
      ),
      readFixture<import("../../../src/contracts/pipeline.js").JourneyCodegenReportArtifact>(
        p3FixturesDir,
