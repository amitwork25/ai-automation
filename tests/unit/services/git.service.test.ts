...
import type { FrameworkConfig } from "../../../src/config/framework.config.js";
...
async function createSeededRemote(baseDir: string) {
...
function makeConfig(originDir: string, workspaceDir: string): FrameworkConfig {
  return {
    gitUrl: originDir,
    branch: "main",
    workspaceDir,
